# Adaptated version of: https://github.com/riannevdberg/sylvester-flows/blob/master/models/VAE.py
...
from models.utils.distributions import log_gaussian, log_standard_gaussian, log_bernoulli
...
def multinomial_loss_array(x_logit, x, z_mu, z_var, z_0, z_k, ldj, args, beta=1.):
    ...
    # ln q(z_0)  (not averaged)
    log_q_z0 = log_gaussian(z_0.view(batch_size, -1), mean=z_mu.view(batch_size, -1),
