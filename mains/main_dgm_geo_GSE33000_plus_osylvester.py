...
def __main__():
    geo_ids = ["GSE33000"]
    unlabelled_geo_ids = ["GSE19632", "GSE23314", "GSE24335", "GSE33000", "GSE44772"]
    bad_geo_ids = []
    ...
    a_dim = [10]
    num_elements = 3
    batch_size = 8  # if smaller not working... should work though...
    number_of_flows = 5
    input_shape = [1, 35371]
    ...
    if auxiliary:
        ...
        dgm.set_configs(num_classes=num_classes, extra_class=extra_class, home_path=home_path,
    ...
    dgm.run(n_epochs, auxiliary, mc, iw, lambda1=l1, lambda2=l2, generate_extra_class=10000, t_max=10.)
